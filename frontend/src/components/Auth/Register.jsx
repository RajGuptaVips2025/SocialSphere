...
// import api from '../api'; // Make sure the path is correct based on your project structure
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Note: Our api instance already prefixes endpoints with your backend URL and "/api"
